...
func on_tt_pressed():
	get_node("/root/game").start_placing_building("res://game/scenes/actors/constructions/tetrahedron_of_transmutation/tetrahedron_of_transmutation.tscn")
	
func on_gg_pressed():
	get_node("/root/game").start_placing_building("res://game/scenes/actors/constructions/gear_of_generating/gear_of_generating.tscn")

func on_cc_pressed():
	get_node("/root/game").start_placing_building("res://game/scenes/actors/constructions/cone_of_construction/cone_of_construction.tscn")
	
func on_oo_pressed():
	get_node("/root/game").start_placing_building("res://game/scenes/actors/constructions/orb_of_observation/orb_of_observation.tscn")
	
func on_collector_pressed():
	get_node("/root/game").spawn_unit("res://game/scenes/actors/units/collector/collector.tscn")
